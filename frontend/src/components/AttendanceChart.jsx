...
const COLORS = { present: '#0891B2', absent: '#E53935', leave: '#1976D2', late: '#F57C00' };
const PIE_COLORS = ['#0891B2','#22D3EE','#E53935','#F57C00','#1976D2','#9C27B0','#FF5722','#607D8B'];
      ...
      <ResponsiveContainer width="100%" height={240}>
        <AreaChart data={formatted} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
          ...
          <Area type="monotone" dataKey="present" name="Present"
            stroke="#0891B2" fill="url(#presentGrad)" strokeWidth={2} dot={false} />
    ...
    <div className="card">
      ...
      <ResponsiveContainer width="100%" height={240}>
        <BarChart data={formatted} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}
          ...
          />
          <Legend iconType="circle" iconSize={8} />
          <Bar dataKey="Present" fill="#0891B2" radius={[4, 4, 0, 0]} />
