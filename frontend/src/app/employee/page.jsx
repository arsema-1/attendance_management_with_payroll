...
import { Clock, LogOut, Wifi, WifiOff, Bell, CheckCircle, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-5 space-y-5 pb-24">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { label: 'Present', value: presentDays, icon: '✅', color: 'text-cyan-700 bg-cyan-50' },
              ...
              {leaves.slice(0, 4).map(l => (
                <div key={l.id} className="px-5 py-3 flex items-center justify-between">
                  ...
                  <span className={
                    ...
                    l.status === 'canceled' ? 'badge-absent' :
                    'badge-pending'
                  }>
