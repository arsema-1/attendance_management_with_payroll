    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          <Link href="/admin/employees/add" className="btn-primary text-sm py-2 px-3 flex items-center gap-1.5">
      ...
      {summary?.pending_leaves > 0 && (
        <div className="bg-amber-50 border border-amber-200 rounded-2xl px-5 py-3.5
          ...
          <Link href="/admin/leave" className="text-amber-700 text-xs font-bold underline">
            Review now →
          </Link>
        </div>
      )}
      ...
      <div className="card p-0 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Link href="/admin/reports" className="text-sm text-brand-primary hover:underline font-medium">
              Full Report →
            </Link>
          </div>
        </div>
